...
class NewTrueTableWrapper(BaseWrapper):
    ...
    def observation_change(self, observation):
        ...
        self.original_observation = deepcopy(observation) # Keep a copy of the observation to use
...
def true_obs_to_table(true_obs, env):
    ...
    wrapper = NewTrueTableWrapper(env, observer_mode=False)
